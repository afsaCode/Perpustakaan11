...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('pegawai.dashboard') }}" class="logo d-flex align-items-center">
                <img src="{{ asset('assets/admin') }}/assets/img/logo.png" alt="">
                <span class="d-none d-lg-block">Perpus11</span>
            </a>
            <i class="bi bi-list toggle-sidebar-btn"></i>
        </div><!-- End Logo -->

        <div class="search-bar">
            <form class="search-form d-flex align-items-center" method="POST" action="{{ url('pegawai.index') }}">
