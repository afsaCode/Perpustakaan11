                    ...
                    <div class="card" id="input">
                        <div class="card-body">
                            ...
                            <form action='{{ route('bukuanak.store') }}' method='post'>
                                @csrf
                                 <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">ID Buku Induk</label>
                                    <div class="col-sm-10">
                                      <select class="form-select" aria-label="Default select example" name="id_bukuinduk" >
                                        <option selected>Pilih ID Buku</option>
                                        @foreach ($id_bukuinduks as $id_bukuinduk)
                                            <option name="id_bukuinduk" value="{{ $id_bukuinduk->id_bukuinduk }}">{{ $id_bukuinduk->id_bukuinduk }}</option>
                                        @endforeach
                                      </select>
                                    </div>
                                  </div>
