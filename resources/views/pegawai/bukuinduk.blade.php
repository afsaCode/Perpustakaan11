        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content active " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('bukuinduk.index') }}" class="nav-link active">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Data Buku Induk</h5>

                            <!-- TOMBOL TAMBAH DATA -->
                            <div class="pb-2">
                                <a href='{{ route('bukuinduk.create') }}' class="btn btn-primary">+ Tambah Data</a>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href='{{ route('bukuinduk.edit', $item->id_bukuinduk) }}' class="btn btn-warning btn-sm">Edit</a>
                                                <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ route('bukuinduk.destroy', $item->id_bukuinduk) }}" method="POST">
                                                  @csrf
                                                  @method('DELETE')
