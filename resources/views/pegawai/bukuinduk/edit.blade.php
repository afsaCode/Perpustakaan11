                ...
                <div class="col-lg-6">
                    ...
                    <div class="card" id="input">
                        <div class="card-body">
                            ...
                            <!-- Horizontal Form -->
                            <form action='{{ route('bukuinduk.update', $data->id_bukuinduk)  }}' method='post'>
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                      <select class="form-select" aria-label="Default select example" name="kategori" >
                                        ...
                                        @foreach ($kategories as $kategori)
                                            <option name="kategori" value="{{ $kategori->kategori }}">{{ $kategori->kategori }}</option>
                                        @endforeach
                                      </select>
                                    </div>
                                  </div>
                                  <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                      <select class="form-select" aria-label="Default select example" name="rak">
                                        <option>-</option>
                                        <option selected value="{{ $data->rak }}">{{ $data->rak }}</option>
                                        @foreach ($raks as $rak)
