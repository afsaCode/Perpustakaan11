                        ...
                        <div class="card-body">
                            ...
                            <form action='{{ route('kategori.store') }}' method='post'>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="id_kat" name="id_kat"
                                            value="{{ Session::get('id_kat') }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="waktu_peminjaman" name="waktu_peminjaman"
                                            value="{{ Session::get('waktu_peminjaman') }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="harga" class="col-sm-2 col-form-label">Harga Keterlambatan</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="number" id="harga_keterlambatan" name="harga_keterlambatan"
                                        value="{{ Session::get('harga_keterlambatan') }}">
                                    </div>
                                </div>
