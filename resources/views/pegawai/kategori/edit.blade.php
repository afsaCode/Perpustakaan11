                ...
                <div class="col-lg-11">
                    ...
                    <div class="card" id="input">
                        <div class="card-body">
                            ...
                            <!-- Horizontal Form -->
                            <form action='{{ route('kategori.update', $data->id_kat)  }}' method='post'>
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
                                    <label for="id_kat" class="col-sm-2 col-form-label">ID Kategori</label>
                                    <div class="col-sm-10">
                                        {{ $data->id_kat }}
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="waktu_keterlambatan" class="col-sm-2 col-form-label">Waktu
                                        Keterlambatan</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="waktu_peminjaman"
                                            name="waktu_peminjaman" value="{{ $data->waktu_peminjaman }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="harga" class="col-sm-2 col-form-label">Harga Keterlambatan</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="number" id="harga_keterlambatan"
                                            name="harga_keterlambatan" value="{{ $data->harga_keterlambatan }}">
                                    </div>
                                </div>
