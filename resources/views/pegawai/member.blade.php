                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->foto }}</td>
                                            <td>
                                                <a href='{{ route('member.edit', $item->nis_nik) }}' class="btn btn-warning btn-sm">Edit</a>
                                                <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ route('member.destroy', $item->nis_nik) }}" method="POST">
                                                  @csrf
                                                  @method('DELETE')
