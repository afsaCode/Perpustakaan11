                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- TOMBOL TAMBAH DATA -->
                            <div class="pb-3">
                                <a href='{{ route('rak.create') }}' class="btn btn-primary">+ Tambah Data</a>
                            </div>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ route('rak.destroy', $item->id_rak) }}" method="POST">
                                                  @csrf
                                                  @method('DELETE')
